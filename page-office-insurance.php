        ...
        <div class="cover-on" data-aos="fade-right" data-aos-once="true">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_on_office_insurance') ): while ( have_rows('section_cover_on_office_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_office_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="cover-off" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_off_office_insurance') ): while ( have_rows('section_cover_off_office_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_office_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
