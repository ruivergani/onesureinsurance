<?php
  // Template name: commercial-insurance
?>
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_commercial_insurance') ?></span>
          <h1><?php the_field('title_left_commercial_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_commercial_insurance') ): while ( have_rows('list_left_commercial_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_commercial_insurance') ?>" alt="icon checked" title="icon checked">
                <p><?php the_sub_field('text_commercial_insurance') ?></p>
              </li>
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="">
                ...
                <p><?php the_field('mobile_phone_commercial_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              ...
              <a class="text__numbers" href="">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_commercial_insurance') ?></p>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="s-hero-insurance__right">
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_commercial_insurance') ?></span>
          <h2><?php the_field('title_right_commercial_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_commercial_insurance') ?></p>
                <span><?php the_field('subtitle_01_commercial_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_commercial_insurance') ?></p>
                <span><?php the_field('subtitle_02_commercial_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_commercial_insurance') ?></p>
                <span><?php the_field('subtitle_03_commercial_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <section class="s-featured-content">
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        <h4><?php the_field('title_featured_content_commercial_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_commercial_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_commercial_insurance') ?>" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="s-featured-secondary-content">
    <div class="container">
      ...
      <div class="s-featured-content__left" data-aos="fade-left" data-aos-once="true">
        <h4><?php the_field('title_featured_content_secondary_commercial_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_secondary_commercial_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_commercial_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_commercial_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_commercial_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_commercial_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_commercial_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_right_column_commercial_insurance') ?>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="s-cover" id="s-cover">
    <div class="container">
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        <h6><?php the_field('mobile_title_section_cover_commercial_insurance'); ?></h6>
        <ul>
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_cover_on_commercial_insurance') ): while ( have_rows('section_cover_on_commercial_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_commercial_insurance'); ?>" alt="icon checked" title="icon checked">
              <p><?php the_sub_field('text_cover_on_commercial_insurance'); ?></p>
            </li>
          <?php endwhile; else : endif;?>
        </ul>
      </div>
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_cover_off_commercial_insurance') ): while ( have_rows('section_cover_off_commercial_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_commercial_insurance'); ?>" alt="icon not checked" title="icon not checked">
              <p><?php the_sub_field('text_cover_off_commercial_insurance'); ?></p>
            </li>
          <?php endwhile; else : endif;?>
        </ul>
      </div>
  ...
  <section class="s-slide-product">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_product_slide_commercial_insurance') ?></h6>
        <h4><?php the_field('title_section_product_slide_commercial_insurance') ?></h4>
      ...
      <div class="slide-product">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('card_product_slide_commercial_insurance') ): while ( have_rows('card_product_slide_commercial_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Product Type -->
              <a href="<?php the_sub_field('card_link_commercial_insurance') ?>" class="card-product">
                <div class="image">
                    <img src="<?php the_sub_field('image_card_commercial_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                    <h6><?php the_sub_field('card_title_commercial_insurance') ?></h6>
                    <p><?php the_sub_field('subtitle_card_commercial_insurance') ?></p>
  ...
  <section class="s-price-insurance">
    <div class="container">
      ...
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_commercial_insurance') ?>
      </div>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_commercial_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
  ...
  <?php if ($the_query->have_posts()) : ?>
    <section class="s-articles" id="s-articles">
      <div class="container">
        <div class="text-top">
          <h6><?php the_field('mobile_title_section_articles_commercial_insurance'); ?></h6>
