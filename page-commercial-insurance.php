      ...
      <div class="product">
        ...
        <div class="left-text" data-aos="fade-right" data-aos-once="true">
          ...
          <ul>
            ...
            <?php if( have_rows('list_get_quote_commercial_insurance') ): while ( have_rows('list_get_quote_commercial_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_commercial_insurance') ?>" alt="icon green checked" title="icon green checked">
        ...
        <div class="right-text" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            <li>
              ...
              <p>Call our landline at <span><?php the_field('landline_phone_commercial_insurance') ?></span></p>
            </li>
            <li>
              ...
              <p>Call your mobile at <span><?php the_field('mobile_phone_commercial_insurance') ?></span></p>
            </li>
          </ul>
