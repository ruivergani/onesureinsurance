...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-hero-insurance">
    <div class="container">
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_tattoo_insurance') ): while ( have_rows('list_left_tattoo_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_tattoo_insurance') ?>" alt="icon checked" title="icon checked">
      ...
      <div class="s-hero-insurance__right">
        ...
        <a href="<?php the_field('link_right_tattoo_insurance') ?>" class="btn btn-primary-lg">
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_tattoo_insurance') ): while ( have_rows('section_cover_on_tattoo_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_tattoo_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_tattoo_insurance') ): while ( have_rows('section_cover_off_tattoo_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_tattoo_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_tattoo_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="s-why-us">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_tattoo_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_tattoo_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_tattoo_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
    </div>
  </section>
  ...
  <section class="s-price-insurance">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_tattoo_insurance') ?></h4>
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_tattoo_insurance') ?>
      </div>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_tattoo_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_tattoo_insurance') ?></p>
      </div>
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        <p><?php the_field('title_secondary_card_section_price_tattoo_insurance') ?></p>
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_tattoo_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_tattoo_insurance') ?></span>
    </div>
  </section>
