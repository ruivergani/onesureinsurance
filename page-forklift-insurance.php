...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_forklift_insurance') ?></span>
          <h1><?php the_field('title_left_forklift_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_forklift_insurance') ): while ( have_rows('list_left_forklift_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_forklift_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_forklift_insurance') ?>">
                <span>MOBILE FRIENDLY</span>
                <p><?php the_field('mobile_phone_forklift_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="" width="40" height="40">
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_forklift_insurance') ?>">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_forklift_insurance') ?></p>
              </a>
            </li>
          </ul>
      ...
      <div class="s-hero-insurance__right">
        ...
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_forklift_insurance') ?></span>
          <h2><?php the_field('title_right_forklift_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_forklift_insurance') ?></p>
                <span><?php the_field('subtitle_01_forklift_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_forklift_insurance') ?></p>
                <span><?php the_field('subtitle_02_forklift_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_forklift_insurance') ?></p>
                <span><?php the_field('subtitle_03_forklift_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
              ...
              <a href="<?php the_sub_field('card_link_forklift_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_forklift_insurance') ?></span>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_section_why_us_forklift_insurance') ?></h4>
        <p><?php the_field('subtitle_section_why_us_forklift_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_forklift_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
      <p class="terms-conditions-why-us"><?php the_field('terms_conditions_why_us_forklift_insurance') ?></p>
    </div>
  </section>
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_forklift_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_forklift_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_forklift_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_forklift_insurance') ?></p>
