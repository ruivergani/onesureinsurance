...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_van_insurance') ): while ( have_rows('list_left_van_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_van_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <?php if( have_rows('section_optional_extras_cards_van_insurance') ): while ( have_rows('section_optional_extras_cards_van_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_van_insurance') ?>" alt="" height="45" width="45">
              <div class="text">
  ...
  <section class="s-cover" id="cover">
    <div class="container">
      <h4><?php the_field('cover_title_van_insurance'); ?></h4>
        ...
        <div class="cover-on">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_on_van_insurance') ): while ( have_rows('section_cover_on_van_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_van_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="cover-off">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_off_van_insurance') ): while ( have_rows('section_cover_off_van_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_van_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
              ...
              <a href="<?php the_sub_field('card_link_van_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                      <span><?php the_sub_field('link_text_card_title_van_insurance') ?></span>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_section_why_us_van_insurance') ?></h4>
        <p><?php the_field('subtitle_section_why_us_van_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_van_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
      <p class="terms-conditions-why-us"><?php the_field('terms_conditions_why_us_van_insurance') ?></p>
    </div>
  </section>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4><?php the_field('title_section_price_van_insurance') ?></h4>
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_van_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_van_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_van_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_van_insurance') ?></p>
