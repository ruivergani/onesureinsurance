...
<?php
  // Template name: van-minibus-insurance
?>
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_van_minibus_insurance') ?></span>
          <h1><?php the_field('title_left_van_minibus_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_van_minibus_insurance') ): while ( have_rows('list_left_van_minibus_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_van_minibus_insurance') ?>" alt="icon checked" title="icon checked">
                <p><?php the_sub_field('text_van_minibus_insurance') ?></p>
              </li>
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="">
                ...
                <p><?php the_field('mobile_phone_van_minibus_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              ...
              <a class="text__numbers" href="">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_van_minibus_insurance') ?></p>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="s-hero-insurance__right">
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_van_minibus_insurance') ?></span>
        ...
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_van_minibus_insurance') ?></p>
                <span><?php the_field('subtitle_01_van_minibus_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_van_minibus_insurance') ?></p>
                <span><?php the_field('subtitle_02_van_minibus_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_van_minibus_insurance') ?></p>
                <span><?php the_field('subtitle_03_van_minibus_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
        <a href="<?php the_field('link_right_van_minibus_insurance') ?>" class="btn btn-primary-lg">
    ...
    <div class="container">
      ...
      <ul>
        ...
        <?php if( have_rows('section_optional_extras_cards_van_minibus_insurance') ): while ( have_rows('section_optional_extras_cards_van_minibus_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('link_card_optional_extras_van_minibus_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_van_minibus_insurance') ?>" alt="">
              <div class="text">
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_van_minibus_insurance') ): while ( have_rows('section_cover_on_van_minibus_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_van_minibus_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_van_minibus_insurance') ): while ( have_rows('section_cover_off_van_minibus_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_van_minibus_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <section class="s-slide-product">
    <div class="container">
      <div class="top">
        ...
        <h4><?php the_field('title_section_product_slide_van_minibus_insurance') ?></h4>
      ...
      <div class="slide-product">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('card_product_slide_van_minibus_insurance') ): while ( have_rows('card_product_slide_van_minibus_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Product Type -->
              <a href="<?php the_sub_field('card_link_van_minibus_insurance') ?>" class="card-product">
                <div class="image">
                    <img src="<?php the_sub_field('image_card_van_minibus_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_van_minibus_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
        ...
        <div class="text-bottom" data-aos="fade-right" data-aos-once="true">
          <ul>
            ...
            <?php if( have_rows('cards_section_why_us_van_minibus_insurance') ): while ( have_rows('cards_section_why_us_van_minibus_insurance') ) : the_row(); ?>
              <!-- Card -->
              <li>
                <img src="<?php the_sub_field('icon_card_van_minibus_insurance'); ?>" alt="icon house" title="icon house">
                <h5><?php the_sub_field('title_why_us_card_van_minibus_insurance'); ?></h5>
                <p><?php the_sub_field('description_why_us_card_van_minibus_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
  ...
  <section class="s-price-insurance">
    <div class="container">
      ...
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_van_minibus_insurance') ?>
      </div>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_van_minibus_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
  ...
  <section class="s-faqs padding-bottom" id="s-faqs" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      ...
      <div class="b-container">
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_faq_van_minibus_insurance') ): while ( have_rows('section_faq_van_minibus_insurance') ) : the_row(); ?>
          <!-- Question Card -->
          <div class="question">
            <div class="title js-question">
              <strong><?php the_sub_field('title_faq_van_minibus_insurance'); ?></strong>
              <i class="fa-solid fa-chevron-down"></i>
            </div>
            <div class="question-content">
              <?php the_sub_field('description_faq_van_minibus_insurance'); ?>
            </div>
          </div>
        <?php endwhile; else : endif;?>
      </div>
  ...
  <?php if ($the_query->have_posts()) : ?>
    <section class="s-articles" id="s-articles">
      <div class="container">
        <div class="text-top">
          <h6><?php the_field('mobile_title_section_articles_van_minibus_insurance'); ?></h6>
          <h4><?php the_field('title_section_articles_van_minibus_insurance'); ?></h4>
          <p><?php the_field('description_section_articles_van_minibus_insurance'); ?></p>
        </div>
