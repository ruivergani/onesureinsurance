...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_van_minibus_insurance') ): while ( have_rows('list_left_van_minibus_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_van_minibus_insurance') ?>" alt="icon checked"title="icon checked" width="18" height="18">
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_van_minibus_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_van_minibus_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_van_minibus_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_van_minibus_insurance') ?></p>
