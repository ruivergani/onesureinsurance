...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
     ...
     <div class="custom-select-content">
        <select id="dropdown-select-content" class="select-mobile-config">
          ...
          <option value="#motorbikeinsurance">
            <p>Motorbike Insurance Cover</p>
          </option>
          <option value="#extras">
            <p>Optional Extras</p>
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_motorbike_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_motorbike_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_motorbike_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_motorbike_insurance') ?></p>
