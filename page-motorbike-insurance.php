...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="product">
        ...
        <div class="left-text" data-aos="fade-right" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('get_quote_sub_title_motorbike_insurance') ?></span>
          <h1><?php the_field('get_quote_title_motorbike_insurance') ?></h1>
          <ul>
            <!-- Repeater List Section Hero --> 
            <?php if( have_rows('list_get_quote_motorbike_insurance') ): while ( have_rows('list_get_quote_motorbike_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_motorbike_insurance') ?>" alt="icon green checked" title="icon green checked">
        ...
        <div class="right-text" data-aos="fade-left" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('call_us_subtitle_motorbike_insurance') ?></span>
          <h2><?php the_field('call_us_title_motorbike_insurance') ?></h2>
          <ul>
            <li>
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="icon phone" title="icon phone">
              <p>Call our landline at <span><?php the_field('landline_phone_motorbike_insurance') ?></span></p>
            </li>
            <li>
              ...
              <p>Call your mobile at <span><?php the_field('mobile_phone_motorbike_insurance') ?></span></p>
            </li>
          </ul>
    ...
    <div class="container">
      ...
      <ul>
        ...
        <?php if( have_rows('section_optional_extras_cards_motorbike_insurance') ): while ( have_rows('section_optional_extras_cards_motorbike_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('link_card_optional_extras_motorbike_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_motorbike_insurance') ?>" alt="">
              <div class="text">
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_motorbike_insurance') ): while ( have_rows('section_cover_on_motorbike_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_motorbike_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_motorbike_insurance') ): while ( have_rows('section_cover_off_motorbike_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_motorbike_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_motorbike_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="s-why-us">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_motorbike_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_motorbike_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_motorbike_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
    </div>
  </section>
  ...
  <section class="s-price-insurance">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_motorbike_insurance') ?></h4>
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_motorbike_insurance') ?>
      </div>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_motorbike_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_motorbike_insurance') ?></span>
    </div>
  </section>
