        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_restaurant_pub_insurance') ): while ( have_rows('list_left_restaurant_pub_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_restaurant_pub_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <?php if( have_rows('section_optional_extras_cards_restaurant_pub_insurance') ): while ( have_rows('section_optional_extras_cards_restaurant_pub_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_restaurant_pub_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
