<?php
  // Template name: car-mature-driver-insurance
?>
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_car_mature_insurance') ?></span>
          <h1><?php the_field('title_left_car_mature_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_car_mature_insurance') ): while ( have_rows('list_left_car_mature_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_car_mature_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
                <p><?php the_sub_field('text_car_mature_insurance') ?></p>
              </li>
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_car_mature_insurance') ?>">
                <span>MOBILE FRIENDLY</span>
                <p><?php the_field('mobile_phone_car_mature_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="" width="40" height="40">
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_car_mature_insurance') ?>">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_car_mature_insurance') ?></p>
              </a>
            </li>
          </ul>
      ...
      <div class="s-hero-insurance__right">
        ...
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_car_mature_insurance') ?></span>
        ...
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_car_mature_insurance') ?></p>
                <span><?php the_field('subtitle_01_car_mature_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_car_mature_insurance') ?></p>
                <span><?php the_field('subtitle_02_car_mature_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_car_mature_insurance') ?></p>
                <span><?php the_field('subtitle_03_car_mature_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        ...
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_car_mature_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_car_mature_insurance') ?>" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="s-featured-secondary-content">
    <div class="container">
      <div class="s-featured-content__right" data-aos="fade-right" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_secondary_car_mature_insurance') ?>" alt="">
      </div>
      <div class="s-featured-content__left" data-aos="fade-left" data-aos-once="true">
        <h4><?php the_field('title_featured_content_secondary_car_mature_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_secondary_car_mature_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_car_mature_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_car_mature_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_car_mature_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_car_mature_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_car_mature_insurance') ?></h4>
        <div class="s-column-content-card-text">
    ...
    <div class="container">
      ...
      <div class="cover-section">
        <div class="cover-on" data-aos="fade-right" data-aos-once="true">
          ...
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_on_car_mature_insurance') ): while ( have_rows('section_cover_on_car_mature_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_car_mature_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
                <p><?php the_sub_field('text_cover_on_car_mature_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
        <div class="cover-off" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_off_car_mature_insurance') ): while ( have_rows('section_cover_off_car_mature_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_car_mature_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
                <p><?php the_sub_field('text_cover_off_car_mature_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
  ...
  <section class="s-slide-product" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_product_slide_car_mature_insurance') ?></h6>
        <h4><?php the_field('title_section_product_slide_car_mature_insurance') ?></h4>
      ...
      <div class="slide-product">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('card_product_slide_car_mature_insurance') ): while ( have_rows('card_product_slide_car_mature_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Product Type -->
              <a href="<?php the_sub_field('card_link_car_mature_insurance') ?>" class="card-product">
                <div class="image">
                    <img src="<?php the_sub_field('image_card_car_mature_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                    <h6><?php the_sub_field('card_title_car_mature_insurance') ?></h6>
                    <p><?php the_sub_field('subtitle_card_car_mature_insurance') ?></p>
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_car_mature_insurance') ?></span>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_car_mature_insurance') ?>" class="large-cta js-open-modal" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
            <span><?php the_field('subtitle_cta_car_mature_insurance') ?></span>
            <h3><?php the_field('title_cta_car_mature_insurance') ?></h3>
        </div>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        <h6><?php the_field('mobile_title_section_why_us_car_mature_insurance') ?></h6>
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_car_mature_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_car_mature_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        <div class="text-bottom" data-aos="fade-right" data-aos-once="true">
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('cards_section_why_us_car_mature_insurance') ): while ( have_rows('cards_section_why_us_car_mature_insurance') ) : the_row(); ?>
              <!-- Card -->
              <li>
                <img src="<?php the_sub_field('icon_card_car_mature_insurance'); ?>" alt="icon house" title="icon house">
                <h5><?php the_sub_field('title_why_us_card_car_mature_insurance'); ?></h5>
                <p><?php the_sub_field('description_why_us_card_car_mature_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
        <img src="<?php the_field('image_section_why_us_car_mature_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_car_mature_insurance') ?></h4>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary js-open-modal" href="<?php the_field('link_secondary_card_section_price_car_mature_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_car_mature_insurance') ?></span>
    </div>
  </section>
  ...
  <section class="s-faqs padding-bottom" id="faqs" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h4><?php the_field('title_section_car_mature_insurance') ?></h4>
      <div class="b-container">
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_faq_car_mature_insurance') ): while ( have_rows('section_faq_car_mature_insurance') ) : the_row(); ?>
          <!-- Question Card -->
          <div class="question">
            <div class="title js-question">
              <strong><?php the_sub_field('title_faq_car_mature_insurance'); ?></strong>
              <i class="fa-solid fa-chevron-down"></i>
            </div>
            <div class="question-content">
              <?php the_sub_field('description_faq_car_mature_insurance'); ?>
            </div>
          </div>
        <?php endwhile; else : endif;?>
      </div>
  ...
  <?php if ($the_query->have_posts()) : ?>
    <section class="s-articles" id="s-articles">
      <div class="container">
        <div class="text-top">
          <h6><?php the_field('mobile_title_section_articles_car_mature_insurance'); ?></h6>
          <h4><?php the_field('title_section_articles_car_mature_insurance'); ?></h4>
          <p><?php the_field('description_section_articles_car_mature_insurance'); ?></p>
        </div>
