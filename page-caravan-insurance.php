...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-extras-opt" id="s-extras-opt" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h6><?php the_field('mobile_title_section_optional_extras_caravan_insurance') ?></h6>
      <h4><?php the_field('title_section_optional_extras_caravan_insurance') ?></h4>
      <ul>
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_optional_extras_cards_caravan_insurance') ): while ( have_rows('section_optional_extras_cards_caravan_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('link_card_optional_extras_caravan_insurance') ?>">
            <img src="<?php the_sub_field('image_card_optional_extras_caravan_insurance') ?>" alt="">
              <div class="text">
                <h5><?php the_sub_field('title_card_optional_extras_caravan_insurance') ?></h5>
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_caravan_insurance') ): while ( have_rows('section_cover_on_caravan_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_caravan_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_caravan_insurance') ): while ( have_rows('section_cover_off_caravan_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_caravan_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_caravan_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="s-why-us">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_caravan_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_caravan_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_caravan_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
    </div>
  </section>
  ...
  <section class="s-price-insurance">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_caravan_insurance') ?></h4>
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_caravan_insurance') ?>
      </div>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_caravan_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_caravan_insurance') ?></p>
      </div>
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        <p><?php the_field('title_secondary_card_section_price_caravan_insurance') ?></p>
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_caravan_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_caravan_insurance') ?></span>
    </div>
  </section>
