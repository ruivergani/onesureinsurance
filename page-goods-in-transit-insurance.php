...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_goods_insurance') ?></span>
          <h1><?php the_field('title_left_goods_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_goods_insurance') ): while ( have_rows('list_left_goods_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_goods_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_goods_insurance') ?>">
                <span>MOBILE FRIENDLY</span>
                <p><?php the_field('mobile_phone_goods_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="" width="40" height="40">
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_goods_insurance') ?>">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_goods_insurance') ?></p>
              </a>
            </li>
          </ul>
      ...
      <div class="s-hero-insurance__right">
        ...
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_goods_insurance') ?></span>
          <h2><?php the_field('title_right_goods_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_goods_insurance') ?></p>
                <span><?php the_field('subtitle_01_goods_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_goods_insurance') ?></p>
                <span><?php the_field('subtitle_02_goods_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_goods_insurance') ?></p>
                <span><?php the_field('subtitle_03_goods_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <section class="s-table-contents" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      ...
      <ul class="js-nav-product" id="js-nav-product">
        ...
        <li class="js-item-content">
          <a href="#goodsinsurance" class="anchor">
            <p>Goods Insurance Cover</p>
          </a>
        </li>
        <li class="js-item-content">
  ...
  <section class="s-featured-content">
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        <h4><?php the_field('title_featured_content_goods_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_goods_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_goods_insurance') ?>" alt="">
      </div>
    </div>
  </section>

  <!-- Section Column Content -->
  <section class="s-column-content" id="goodsinsurance" style="padding-top: 6rem;">
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_goods_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_goods_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_goods_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_goods_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_goods_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_right_column_goods_insurance') ?>
        </div>
      </div>
    </div>
  </section>
        ...
        <?php if( have_rows('section_optional_extras_cards_goods_insurance') ): while ( have_rows('section_optional_extras_cards_goods_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_goods_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
    ...
    <div class="container">
      ...
      <div class="cover-section">
        <div class="cover-on" data-aos="fade-right" data-aos-once="true">
          <h6><?php the_field('mobile_title_section_cover_goods_insurance'); ?></h6>
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_on_goods_insurance') ): while ( have_rows('section_cover_on_goods_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_goods_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
                <p><?php the_sub_field('text_cover_on_goods_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
        <div class="cover-off" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_off_goods_insurance') ): while ( have_rows('section_cover_off_goods_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_goods_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
                <p><?php the_sub_field('text_cover_off_goods_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
              ...
              <a href="<?php the_sub_field('card_link_goods_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_goods_insurance') ?></span>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_goods_insurance') ?>" class="large-cta js-open-modal" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_goods_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_goods_insurance') ?></p>
      </div>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_goods_insurance') ?></h4>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_goods_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_goods_insurance') ?></p>
      </div>
      ...
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_goods_insurance') ?></span>
    </div>
  </section>
