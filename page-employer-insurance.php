...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_employer_insurance') ?></span>
          <h1><?php the_field('title_left_employer_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_employer_insurance') ): while ( have_rows('list_left_employer_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_employer_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_employer_insurance') ?>">
                <span>MOBILE FRIENDLY</span>
                <p><?php the_field('mobile_phone_employer_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="" width="40" height="40">
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_employer_insurance') ?>">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_employer_insurance') ?></p>
              </a>
            </li>
          </ul>
      ...
      <div class="s-hero-insurance__right">
        ...
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_employer_insurance') ?></span>
          <h2><?php the_field('title_right_employer_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_employer_insurance') ?></p>
                <span><?php the_field('subtitle_01_employer_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_employer_insurance') ?></p>
                <span><?php the_field('subtitle_02_employer_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_employer_insurance') ?></p>
                <span><?php the_field('subtitle_03_employer_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <section class="s-featured-content">
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        <h4><?php the_field('title_featured_content_employer_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_employer_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_employer_insurance') ?>" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="s-featured-secondary-content">
    <div class="container">
      <div class="s-featured-content__right" data-aos="fade-right" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_secondary_employer_insurance') ?>" alt="">
      </div>
      <div class="s-featured-content__left" data-aos="fade-left" data-aos-once="true">
        <h4><?php the_field('title_featured_content_secondary_employer_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_secondary_employer_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_employer_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_employer_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_employer_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_employer_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_employer_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_right_column_employer_insurance') ?>
        </div>
      </div>
    </div>
  </section>
        ...
        <?php if( have_rows('section_optional_extras_cards_employer_insurance') ): while ( have_rows('section_optional_extras_cards_employer_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_employer_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
    ...
    <div class="container">
      ...
      <div class="cover-section">
        <div class="cover-on" data-aos="fade-right" data-aos-once="true">
          ...
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_on_employer_insurance') ): while ( have_rows('section_cover_on_employer_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_employer_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
                <p><?php the_sub_field('text_cover_on_employer_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
        <div class="cover-off" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('section_cover_off_employer_insurance') ): while ( have_rows('section_cover_off_employer_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_employer_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
                <p><?php the_sub_field('text_cover_off_employer_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
              ...
              <a href="<?php the_sub_field('card_link_employer_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_employer_insurance') ?></span>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      ...
      <p class="terms-conditions-why-us"><?php the_field('terms_conditions_why_us_employer_insurance') ?></p>
    </div>
  </section>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_employer_insurance') ?></h4>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_employer_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_employer_insurance') ?></p>
      </div>
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        <p><?php the_field('title_secondary_card_section_price_employer_insurance') ?></p>
        <a class="btn btn-primary js-open-modal" href="<?php the_field('link_secondary_card_section_price_employer_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_employer_insurance') ?></span>
    </div>
  </section>
