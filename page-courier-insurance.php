...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_courier_insurance') ): while ( have_rows('list_left_courier_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_courier_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_courier_insurance') ?>">
            ...
            <li class="landline">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_courier_insurance') ?>">
                <span>TELEPHONE</span>
        ...
        <?php if( have_rows('section_optional_extras_cards_courier_insurance') ): while ( have_rows('section_optional_extras_cards_courier_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_courier_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
        ...
        <div class="cover-on">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_on_courier_insurance') ): while ( have_rows('section_cover_on_courier_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_courier_insurance'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="cover-off">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_off_courier_insurance') ): while ( have_rows('section_cover_off_courier_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_courier_insurance'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
              ...
              <a href="<?php the_sub_field('card_link_courier_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_courier_insurance') ?></span>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_courier_insurance') ?>" class="large-cta js-open-modal">
        <div class="text">
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_section_why_us_courier_insurance') ?></h4>
        <p><?php the_field('subtitle_section_why_us_courier_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_courier_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
      <p class="terms-conditions-why-us"><?php the_field('terms_conditions_why_us_courier_insurance') ?></p>
    </div>
  </section>
  ...
  <section class="s-price-insurance hide" id="price">
    <div class="container">
      <h4><?php the_field('title_section_price_courier_insurance') ?></h4>
      ...
      <div class="s-price-insurance__card-quote">
        ...
        <a class="btn btn-primary js-open-modal" href="<?php the_field('link_secondary_card_section_price_courier_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span><?php the_field('span_section_price_courier_insurance') ?></span>
    </div>
  </section>
