...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="product">
        ...
        <div class="left-text" data-aos="fade-right">
          <span class="sm-text-product"><?php the_field('get_quote_sub_title_courier_insurance') ?></span>
          <h1><?php the_field('get_quote_title_courier_insurance') ?></h1>
          <ul>
            <!-- Repeater List Section Hero --> 
            <?php if( have_rows('list_get_quote_courier_insurance') ): while ( have_rows('list_get_quote_courier_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_courier_insurance') ?>" alt="icon green checked" title="icon green checked">
        ...
        <div class="right-text" data-aos="fade-left">
          <span class="sm-text-product"><?php the_field('call_us_subtitle_courier_insurance') ?></span>
          <h2><?php the_field('call_us_title_courier_insurance') ?></h2>
          <ul>
            <li>
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="icon phone" title="icon phone">
              <p>Call our landline at <span><?php the_field('landline_phone_courier_insurance') ?></span></p>
            </li>
            <li>
              ...
              <p>Call your mobile at <span><?php the_field('mobile_phone_courier_insurance') ?></span></p>
            </li>
          </ul>
  ...
  <div class="s-newsletter">
      <div class="container">
        <a href="<?php the_field('link_cta_courier_insurance') ?>" class="large-cta" data-aos="zoom-in">
          <div class="text">
  ...
  <section class="s-bespoke" id="s-why-us">
      <div class="container">
        <div class="text-top">
          ...
          <h4 data-aos="fade-right"><?php the_field('title_section_why_us_courier_insurance') ?></h4>
          <p data-aos="fade-left"><?php the_field('subtitle_section_why_us_courier_insurance') ?></p>
        </div>
        <div class="main-bespoke">
          ...
          <img src="<?php the_field('image_section_why_us_courier_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left">
        </div>
      </div>
  </section>
  ...
  <section class="s-slide-van">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_slides_courier_insurance'); ?></h6>
        <h4><?php the_field('title_section_slides_courier_insurance'); ?></h4>
        <div class="ctrl-slide">
          <!-- Swipper pagination structure -->
          <div class="swiper-pagination"></div>
          <div class="ctrl">
      ...
      <div class="slide-van">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_slides_cards_courier_insurance') ): while ( have_rows('section_slides_cards_courier_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Van Type -->
              <a href="<?php the_sub_field('link_slide_card_courier_insurance'); ?>" class="card-van">
                <div class="image">
                  <img src="<?php the_sub_field('image_slide_card_courier_insurance'); ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                  <h6><?php the_sub_field('text_slide_card_courier_insurance'); ?></h6>
                </div>
              </a>
            </div>
          <?php endwhile; else : endif;?>
