...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_cherry_picker_insurance') ): while ( have_rows('list_left_cherry_picker_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cherry_picker_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_cherry_picker_insurance') ?>">
            ...
            <li class="landline">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_cherry_picker_insurance') ?>">
                <span>TELEPHONE</span>
              ...
              <a href="<?php the_sub_field('card_link_cherry_picker_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title_cherry_picker_insurance') ?></span>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_section_why_us_cherry_picker_insurance') ?></h4>
        <p><?php the_field('subtitle_section_why_us_cherry_picker_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_cherry_picker_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
  ...
  <section class="s-banner-cta">
    <div class="container">
      <img src="<?php the_field('image_01_banner_cherry_picker_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_cherry_picker_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_cherry_picker_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_cherry_picker_insurance') ?></p>
