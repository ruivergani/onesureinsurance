...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_takeway_insurance') ): while ( have_rows('list_left_takeway_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_takeway_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_takeway_insurance') ?>">
            ...
            <li class="landline">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_takeway_insurance') ?>">
                <span>TELEPHONE</span>
              ...
              <a href="<?php the_sub_field('card_link_takeway_insurance') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                      <span><?php the_sub_field('link_card_title_takeway_insurance') ?></span>
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_takeway_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_takeway_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_takeway_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_takeway_insurance') ?></p>
