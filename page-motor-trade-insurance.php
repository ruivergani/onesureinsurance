...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_motortrade_insurance') ): while ( have_rows('list_left_motortrade_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_motortrade_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_motortrade_insurance') ?>">
            ...
            <li class="landline">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_motortrade_insurance') ?>">
                <span>TELEPHONE</span>
    ...
    <div class="container">
      ...
      <div class="custom-select-content">
        <select id="dropdown-select-content" class="select-mobile-config">
          ...
          <option value="#motortradeinsurance">
            <p>Motor Trade Insurance Cover</p>
          </option>
          <option value="#extras">
            <p>Optional Extras</p>
        ...
        <?php if( have_rows('section_optional_extras_cards') ): while ( have_rows('section_optional_extras_cards') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_motortrade_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
        ...
        <div class="cover-on">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_on') ): while ( have_rows('section_cover_on') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on'); ?>" alt="icon checked" title="icon checked" width="18" height="18">
        ...
        <div class="cover-off">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_off') ): while ( have_rows('section_cover_off') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off'); ?>" alt="icon not checked" title="icon not checked" width="23" height="23">
              ...
              <a href="<?php the_sub_field('card_link') ?>" class="card-product">
                ...
                <div class="info">
                    ...
                    <div class="learn-more">
                        <span><?php the_sub_field('link_card_title') ?></span>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_why_us_motortrade') ?></h4>
        <p><?php the_field('subtitle_why_us_motortrade') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_why_us_motortrade') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4><?php the_field('title_section_price_motortrade_insurance') ?></h4>
      ...
      <span><?php the_field('span_section_price_motortrade_insurance') ?></span>
    </div>
  </section>

  <!-- Section FAQs -->
  <section class="s-faqs padding-bottom padding-top" id="faqs">
    <div class="container">
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_motortrade') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_motortrade') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_motortrade') ?></h2>
        <p><?php the_field('subtitle_banner_motortrade') ?></p>
