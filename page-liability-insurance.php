...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-hero-insurance">
    <div class="container">
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_liability_insurance') ): while ( have_rows('list_left_liability_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_liability_insurance') ?>" alt="icon checked" title="icon checked">
      ...
      <div class="s-hero-insurance__right">
        ...
        <a href="<?php the_field('link_right_liability_insurance') ?>" class="btn btn-primary-lg">
  ...
  <section class="s-table-contents" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      ...
      <ul class="js-nav-product" id="js-nav-product">
        ...
        <li class="js-item-content">
          <a href="#liabilityinsurance" class="anchor">
    ...
    <div class="container">
      ...
      <ul>
        ...
        <?php if( have_rows('section_optional_extras_cards_liability_insurance') ): while ( have_rows('section_optional_extras_cards_liability_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('link_card_optional_extras_liability_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_liability_insurance') ?>" alt="">
              <div class="text">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_liability_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_liability_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_liability_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_liability_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
    </div>
  </section>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_liability_insurance') ?></h4>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_liability_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_liability_insurance') ?></span>
    </div>
  </section>
  ...
  <section class="s-faqs padding-bottom" id="faqs" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h4><?php the_field('title_section_liability_insurance') ?></h4>
      <div class="b-container">
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_faq_liability_insurance') ): while ( have_rows('section_faq_liability_insurance') ) : the_row(); ?>
          <!-- Question Card -->
          <div class="question">
            <div class="title js-question">
              <strong><?php the_sub_field('title_faq_liability_insurance'); ?></strong>
              <i class="fa-solid fa-chevron-down"></i>
            </div>
            <div class="question-content">
              <?php the_sub_field('description_faq_liability_insurance'); ?>
            </div>
          </div>
        <?php endwhile; else : endif;?>
      </div>
