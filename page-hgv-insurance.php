...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_hgv_insurance') ?></span>
          <h1><?php the_field('title_left_hgv_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_hgv_insurance') ): while ( have_rows('list_left_hgv_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_hgv_insurance') ?>" alt="icon checked" title="icon checked">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="">
                ...
                <p><?php the_field('mobile_phone_hgv_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              ...
              <a class="text__numbers" href="">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_hgv_insurance') ?></p>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="s-hero-insurance__right">
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_hgv_insurance') ?></span>
          <h2><?php the_field('title_right_hgv_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_hgv_insurance') ?></p>
                <span><?php the_field('subtitle_01_hgv_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_hgv_insurance') ?></p>
                <span><?php the_field('subtitle_02_hgv_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_hgv_insurance') ?></p>
                <span><?php the_field('subtitle_03_hgv_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
        <a href="<?php the_field('link_right_hgv_insurance') ?>" class="btn btn-primary-lg">
  ...
  <section class="s-featured-content">
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        <h4><?php the_field('title_featured_content_hgv_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_hgv_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_hgv_insurance') ?>" alt="">
      </div>
    </div>
  </section>
  ...
  <section class="s-featured-secondary-content">
    <div class="container">
      <div class="s-featured-content__right" data-aos="fade-right" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_secondary_hgv_insurance') ?>" alt="">
      </div>
      <div class="s-featured-content__left" data-aos="fade-left" data-aos-once="true">
        <h4><?php the_field('title_featured_content_secondary_hgv_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_secondary_hgv_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_hgv_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_hgv_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_hgv_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_hgv_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_hgv_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_right_column_hgv_insurance') ?>
        </div>
      </div>
    </div>
  </section>
        ...
        <?php if( have_rows('section_optional_extras_cards_hgv_insurance') ): while ( have_rows('section_optional_extras_cards_hgv_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('card_link_optional_extras_hgv_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_hgv_insurance') ?>" alt="">
              <div class="text">
  ...
  <section class="s-cover" id="s-cover">
    <div class="container">
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        <h6><?php the_field('mobile_title_section_cover_hgv_insurance'); ?></h6>
        <ul>
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_cover_on_hgv_insurance') ): while ( have_rows('section_cover_on_hgv_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_hgv_insurance'); ?>" alt="icon checked" title="icon checked">
              <p><?php the_sub_field('text_cover_on_hgv_insurance'); ?></p>
            </li>
          <?php endwhile; else : endif;?>
        </ul>
      </div>
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_cover_off_hgv_insurance') ): while ( have_rows('section_cover_off_hgv_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_hgv_insurance'); ?>" alt="icon not checked" title="icon not checked">
              <p><?php the_sub_field('text_cover_off_hgv_insurance'); ?></p>
            </li>
          <?php endwhile; else : endif;?>
        </ul>
      </div>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_hgv_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="s-why-us">
    <div class="container">
      <div class="text-top">
        ...
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_hgv_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_hgv_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_hgv_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
    </div>
  </section>
  ...
  <section class="s-price-insurance">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_hgv_insurance') ?></h4>
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_hgv_insurance') ?>
      </div>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_hgv_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_hgv_insurance') ?></p>
      </div>
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        <p><?php the_field('title_secondary_card_section_price_hgv_insurance') ?></p>
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_hgv_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_hgv_insurance') ?></span>
    </div>
  </section>
