...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        ...
        <h4><?php the_field('title_section_why_us_hgv_insurance') ?></h4>
        <p><?php the_field('subtitle_section_why_us_hgv_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        ...
        <img src="<?php the_field('image_section_why_us_hgv_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img">
      </div>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      <h4><?php the_field('title_section_price_hgv_insurance') ?></h4>
      ...
      <span><?php the_field('span_section_price_hgv_insurance') ?></span>
    </div>
  </section>
  ...
  <section class="s-banner-cta"> 
    <div class="container">
      <img src="<?php the_field('image_01_banner_hgv_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_hgv_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_hgv_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_hgv_insurance') ?></p>
