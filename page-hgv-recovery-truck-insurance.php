  ...
  <section class="s-slide-van">
    <div class="container">
      ...
      <div class="slide-van">
        <div class="swiper-wrapper">
          <!-- Repeater --> 
          <?php if( have_rows('create_cards_slide_hgv_recovery_truck_insurance') ): while ( have_rows('create_cards_slide_hgv_recovery_truck_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Van Type -->
              <a href="<?php the_sub_field('link_card_slide_hgv_recovery_truck_insurance') ?>" class="card-van">
                <div class="image">
                  <img src="<?php the_sub_field('image_card_slide_hgv_recovery_truck_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                  <h6><?php the_sub_field('text_card_slide_hgv_recovery_truck_insurance') ?></h6>
                </div>
              </a>
            </div>
          <?php endwhile; else : endif;?>
