...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-slide-van">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_slides_scooter_insurance'); ?></h6>
        <h4><?php the_field('title_section_slides_scooter_insurance'); ?></h4>
        <div class="ctrl-slide">
          <!-- Swipper pagination structure -->
          <div class="swiper-pagination"></div>
          <div class="ctrl">
      ...
      <div class="slide-van">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('section_slides_cards_scooter_insurance') ): while ( have_rows('section_slides_cards_scooter_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Van Type -->
              <a href="<?php the_sub_field('link_slide_card_scooter_insurance'); ?>" class="card-van">
                <div class="image">
                  <img src="<?php the_sub_field('image_slide_card_scooter_insurance'); ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                  <h6><?php the_sub_field('text_slide_card_scooter_insurance'); ?></h6>
                </div>
              </a>
            </div>
          <?php endwhile; else : endif;?>
