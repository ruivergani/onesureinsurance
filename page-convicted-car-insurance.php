...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-banner-cta">
    <div class="container">
      <img src="<?php the_field('image_01_banner_convicted_car_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_convicted_car_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_convicted_car_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_convicted_car_insurance') ?></p>
