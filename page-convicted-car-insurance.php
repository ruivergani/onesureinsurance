...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-hero-insurance">
    <div class="container">
        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_convicted_car_insurance') ): while ( have_rows('list_left_convicted_car_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_convicted_car_insurance') ?>" alt="icon checked" title="icon checked">
      ...
      <div class="s-hero-insurance__right">
        ...
        <a href="<?php the_field('link_right_convicted_car_insurance') ?>" class="btn btn-primary-lg">
    ...
    <div class="container">
      ...
      <ul>
        ...
        <?php if( have_rows('section_optional_extras_cards_convicted_car_insurance') ): while ( have_rows('section_optional_extras_cards_convicted_car_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('link_card_optional_extras_convicted_car_insurance') ?>">
            <img src="<?php the_sub_field('image_card_optional_extras_convicted_car_insurance') ?>" alt="">
              <div class="text">
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_convicted_car_insurance') ): while ( have_rows('section_cover_on_convicted_car_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_convicted_car_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_convicted_car_insurance') ): while ( have_rows('section_cover_off_convicted_car_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_convicted_car_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_convicted_car_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true"> 
        <div class="text">
  ...
  <section class="s-price-insurance">
    <div class="container">
      ...
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_convicted_car_insurance') ?>
      </div>
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_convicted_car_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
