...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <div class="container">
      <div class="product">
        ...
        <div class="left-text" data-aos="fade-right" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('get_quote_sub_title_hgv_lorry_insurance') ?></span>
          <h1><?php the_field('get_quote_title_hgv_lorry_insurance') ?></h1>
          <ul>
            <!-- Repeater List Section Hero --> 
            <?php if( have_rows('list_get_quote_hgv_lorry_insurance') ): while ( have_rows('list_get_quote_hgv_lorry_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_hgv_lorry_insurance') ?>" alt="icon green checked" title="icon green checked">
        ...
        <div class="right-text" data-aos="fade-left" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('call_us_subtitle_hgv_lorry_insurance') ?></span>
          <h2><?php the_field('call_us_title_hgv_lorry_insurance') ?></h2>
          <ul>
            <li>
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="icon phone" title="icon phone">
              <p>Landline: <span><?php the_field('landline_phone_hgv_lorry_insurance') ?></span></p>
            </li>
            <li>
              ...
              <p>Mobile: <span><?php the_field('mobile_phone_hgv_lorry_insurance') ?></span></p>
            </li>
          </ul>
  ...
  <section class="s-extras-opt" id="s-extras-opt" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h6><?php the_field('mobile_title_section_optional_extras_hgv_lorry_insurance') ?></h6>
      <h4><?php the_field('title_section_optional_extras_hgv_lorry_insurance') ?></h4>
      <ul>
        <!-- Repeater --> 
        <?php if( have_rows('section_optional_extras_cards_hgv_lorry_insurance') ): while ( have_rows('section_optional_extras_cards_hgv_lorry_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('card_link_optional_extras_hgv_lorry_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_hgv_lorry_insurance') ?>" alt="">
              <div class="text">
                <h5><?php the_sub_field('card_title_optional_extras_hgv_lorry_insurance') ?></h5>
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_hgv_lorry_insurance') ): while ( have_rows('section_cover_on_hgv_lorry_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_hgv_lorry_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_hgv_lorry_insurance') ): while ( have_rows('section_cover_off_hgv_lorry_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_hgv_lorry_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <section class="s-slide-product">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_product_hgv_lorry_insurance') ?></h6>
        <h4><?php the_field('title_section_product_hgv_lorry_insurance') ?></h4>
          ...
          <div class="swiper-slide">
            ...
            <?php if( have_rows('card_product_slide_hgv_lorry_insurance') ): while ( have_rows('card_product_slide_hgv_lorry_insurance') ) : the_row(); ?>
              ...
              <a href="<?php the_sub_field('card_link_hgv_lorry_insurance') ?>" class="card-product">
                <div class="image">
                    <img src="<?php the_sub_field('card_image_hgv_lorry_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_hgv_lorry_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-price-insurance">
    <div class="container">
      <h4 data-aos="fade-up" data-aos-once="true"><?php the_field('title_section_price_hgv_lorry_insurance') ?></h4>
      <div class="s-price-insurance-text" data-aos="fade-up" data-aos-once="true">
        <?php the_field('description_section_price_hgv_lorry_insurance') ?>
      </div>
      <div class="s-price-insurance__card" data-aos="fade-up" data-aos-once="true">
        <h5><?php the_field('title_card_section_price_hgv_lorry_insurance') ?></h5>
        <p><?php the_field('description_card_section_price_hgv_lorry_insurance') ?></p>
      </div>
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        <p><?php the_field('title_secondary_card_section_price_hgv_lorry_insurance') ?></p>
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_hgv_lorry_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
      <span data-aos="fade-up" data-aos-once="true"><?php the_field('span_section_price_hgv_lorry_insurance') ?></span>
    </div>
  </section>
