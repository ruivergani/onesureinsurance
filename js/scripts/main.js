...
const btnOpenModalListClaims = document.querySelectorAll(
  ".js-open-claim-modal"
);
...
const btnOpenModalInsuranceList = document.querySelectorAll(
  ".js-open-modal-insurance"
);
...
const topicsFaqMobile = document.querySelectorAll(
  ".s-faq-content .container .main-content-faq .all-faqs-section .faq-box h2"
);
if (listTopicsFaqMobile) {
  ...
  const allTopicsFaqMobile = document.querySelectorAll(
    ".js-dropdown-select li a"
  );
  ...
  function handleScrollTop(position) {
    if (document) {
      const topicsFaq = document.querySelectorAll(
        ".s-faq-content .container .main-content-faq .all-faqs-section .faq-box h2"
      )[position];
      window.scroll({
        behavior: "smooth",
...
const topics = document.querySelectorAll(
  ".info-post-general .container .info-post-bottom .left-content .content-post h2"
);
if (listTopics) {
...
const topics2 = document.querySelectorAll(
  ".s-page-text .container .left-page-text .content-post h2"
);
if (listTopics2) {
