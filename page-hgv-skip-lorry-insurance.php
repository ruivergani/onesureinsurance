    ...
    <div class="container">
      <div class="product">
        ...
        <div class="left-text" data-aos="fade-right" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('get_quote_sub_title_hgv_skip_insurance') ?></span>
          <h1><?php the_field('get_quote_title_hgv_skip_insurance') ?></h1>
          <ul>
            <!-- Repeater List Section Hero --> 
            <?php if( have_rows('list_get_quote_hgv_skip_insurance') ): while ( have_rows('list_get_quote_hgv_skip_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_hgv_skip_insurance') ?>" alt="icon green checked" title="icon green checked">
        ...
        <div class="right-text" data-aos="fade-left" data-aos-once="true">
          <span class="sm-text-product"><?php the_field('call_us_subtitle_hgv_skip_insurance') ?></span>
          <h2><?php the_field('call_us_title_hgv_skip_insurance') ?></h2>
          <ul>
            <li>
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="icon phone" title="icon phone">
              <p>Landline: <span><?php the_field('landline_phone_hgv_skip_insurance') ?></span></p>
            </li>
            <li>
              ...
              <p>Mobile: <span><?php the_field('mobile_phone_hgv_skip_insurance') ?></span></p>
            </li>
          </ul>
