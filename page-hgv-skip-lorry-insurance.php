...
<?php
  // Template name: hgv-lorry-skip-insurance
?>
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_hgv_skip_insurance') ?></span>
          <h1><?php the_field('title_left_hgv_skip_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_hgv_skip_insurance') ): while ( have_rows('list_left_hgv_skip_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_hgv_skip_insurance') ?>" alt="icon checked" title="icon checked">
                <p><?php the_sub_field('text_hgv_skip_insurance') ?></p>
              </li>
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="">
                ...
                <p><?php the_field('mobile_phone_hgv_skip_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              ...
              <a class="text__numbers" href="">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_hgv_skip_insurance') ?></p>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="s-hero-insurance__right">
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_hgv_skip_insurance') ?></span>
        ...
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_hgv_skip_insurance') ?></p>
                <span><?php the_field('subtitle_01_hgv_skip_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_hgv_skip_insurance') ?></p>
                <span><?php the_field('subtitle_02_hgv_skip_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_hgv_skip_insurance') ?></p>
                <span><?php the_field('subtitle_03_hgv_skip_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
        <a href="<?php the_field('link_right_hgv_skip_insurance') ?>" class="btn btn-primary-lg">
  ...
  <section class="s-table-contents" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      ...
      <ul class="js-nav-product" id="js-nav-product">
        ...
        <li class="js-item-content">
          <a href="#hgvskipinsurance" class="anchor">
            <p>HGV Skip Insurance Cover</p>
          </a>
        </li>
        <li class="js-item-content">
  ...
  <section class="s-featured-content">
    <div class="container">
      <div class="s-featured-content__left" data-aos="fade-right" data-aos-once="true">
        <h4><?php the_field('title_featured_content_hgv_skip_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_hgv_skip_insurance') ?>
        </div>
      </div>
      <div class="s-featured-content__right" data-aos="fade-left" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_hgv_skip_insurance') ?>" alt="">
      </div>
    </div>
  </section>

  <!-- Section Featured Secondary Content -->
  <section class="s-featured-secondary-content" id="hgvskipinsurance">
    <div class="container">
      <div class="s-featured-content__right" data-aos="fade-right" data-aos-once="true">
        <img src="<?php the_field('image_featured_content_secondary_hgv_skip_insurance') ?>" alt="">
      </div>
      <div class="s-featured-content__left" data-aos="fade-left" data-aos-once="true">
        <h4><?php the_field('title_featured_content_secondary_hgv_skip_insurance') ?></h4>
        <div class="s-featured-content__text">
          <?php the_field('description_featured_content_secondary_hgv_skip_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="s-column-content-card" data-aos="fade-right" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_left_column_hgv_skip_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_left_column_hgv_skip_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_left_column_hgv_skip_insurance') ?>
        </div>
      </div>
      <div class="s-column-content-card" data-aos="fade-left" data-aos-once="true">
        <div class="s-column-content-card-image">
          <img src="<?php the_field('image_right_column_hgv_skip_insurance') ?>" alt="">
        </div>
        <h4><?php the_field('title_right_column_hgv_skip_insurance') ?></h4>
        <div class="s-column-content-card-text">
          <?php the_field('description_right_column_hgv_skip_insurance') ?>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <ul>
        ...
        <?php if( have_rows('section_optional_extras_cards_hgv_skip_insurance') ): while ( have_rows('section_optional_extras_cards_hgv_skip_insurance') ) : the_row(); ?>
          <li>
            <a href="<?php the_sub_field('card_link_optional_extras_hgv_skip_insurance') ?>">
              <img src="<?php the_sub_field('image_card_optional_extras_hgv_skip_insurance') ?>" alt="">
              <div class="text">
      ...
      <div class="cover-on" data-aos="fade-right" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_on_hgv_skip_insurance') ): while ( have_rows('section_cover_on_hgv_skip_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_on_hgv_skip_insurance'); ?>" alt="icon checked" title="icon checked">
      ...
      <div class="cover-off" data-aos="fade-left" data-aos-once="true">
        ...
        <ul>
          ...
          <?php if( have_rows('section_cover_off_hgv_skip_insurance') ): while ( have_rows('section_cover_off_hgv_skip_insurance') ) : the_row(); ?>
            <li>
              <img src="<?php the_sub_field('icon_checked_cover_off_hgv_skip_insurance'); ?>" alt="icon not checked" title="icon not checked">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_hgv_skip_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
          <span><?php the_field('subtitle_cta_hgv_skip_insurance') ?></span>
          <h3><?php the_field('title_cta_hgv_skip_insurance') ?></h3>
        </div>
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        <h6><?php the_field('mobile_title_section_why_us_hgv_skip_insurance') ?></h6>
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_hgv_skip_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_hgv_skip_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        <div class="text-bottom" data-aos="fade-right" data-aos-once="true">
          <ul>
              <!-- Repeater --> 
              <?php if( have_rows('cards_section_why_us_hgv_skip_insurance') ): while ( have_rows('cards_section_why_us_hgv_skip_insurance') ) : the_row(); ?>
              <!-- Card -->
              <li>
                <img src="<?php the_sub_field('card_icon_hgv_skip_insurance') ?>" alt="icon house" title="icon house">
                <h5><?php the_sub_field('card_title_hgv_skip_insurance') ?></h5>
                <p><?php the_sub_field('card_subtitle_hgv_skip_insurance') ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary" href="<?php the_field('link_secondary_card_section_price_hgv_skip_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
  ...
  <?php if ($the_query->have_posts()) : ?>
    <section class="s-articles" id="s-articles">
      <div class="container">
        <div class="text-top">
          <h6><?php the_field('mobile_title_section_hgv_skip_insurance'); ?></h6>
          <h4><?php the_field('title_section_hgv_skip_insurance'); ?></h4>
          <p><?php the_field('description_title_section_hgv_skip_insurance'); ?></p>
        </div>
