        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_salon_insurance') ): while ( have_rows('list_left_salon_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_salon_insurance') ?>" alt="icon checked" title="icon checked">
        ...
        <div class="cover-on" data-aos="fade-right" data-aos-once="true">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_on_salon_insurance') ): while ( have_rows('section_cover_on_salon_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_on_salon_insurance'); ?>" alt="icon checked" title="icon checked">
        ...
        <div class="cover-off" data-aos="fade-left" data-aos-once="true">
          ...
          <ul>
            ...
            <?php if( have_rows('section_cover_off_salon_insurance') ): while ( have_rows('section_cover_off_salon_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_cover_off_salon_insurance'); ?>" alt="icon not checked" title="icon not checked">
