...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-banner-cta" style="padding-top:0px;">
    <div class="container">
      <img src="<?php the_field('image_01_banner_car_classic_insurance') ?>" alt="" class="img-banner">
      <img src="<?php the_field('image_02_banner_car_classic_insurance') ?>" alt="" class="img-banner">
      <div class="s-banner-cta-text">
        <h2><?php the_field('title_banner_car_classic_insurance') ?></h2>
        <p><?php the_field('subtitle_banner_car_classic_insurance') ?></p>
