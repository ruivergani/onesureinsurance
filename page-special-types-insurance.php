<?php
  // Template name: special-insurance
?>
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
    ...
    <div class="container">
      <div class="s-hero-insurance__left">
        <div class="s-hero-insurance__left__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_left_special_insurance') ?></span>
          <h1><?php the_field('title_left_special_insurance') ?></h1>
        </div>
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_special_insurance') ): while ( have_rows('list_left_special_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_special_insurance') ?>" alt="icon checked" title="icon checked" width="18" height="18">
                <p><?php the_sub_field('text_special_insurance') ?></p>
              </li>
        ...
        <div class="s-hero-insurance__numbers">
          ...
          <ul>
            <li class="mobile">
              ...
              <a class="text__numbers" href="<?php the_field('link_text_mobile_phone_special_insurance') ?>">
                <span>MOBILE FRIENDLY</span>
                <p><?php the_field('mobile_phone_special_insurance') ?></p>
              </a>
            </li>
            <li class="landline">
              <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-phone-blue.svg" alt="" width="40" height="40">
              <a class="text__numbers" href="<?php the_field('link_text_landline_phone_special_insurance') ?>">
                <span>TELEPHONE</span>
                <p><?php the_field('landline_phone_special_insurance') ?></p>
              </a>
            </li>
          </ul>
      ...
      <div class="s-hero-insurance__right">
        ...
        <div class="s-hero-insurance__right__title">
          <span class="s-hero-insurance__span"><?php the_field('subtitle_right_special_insurance') ?></span>
          <h2><?php the_field('title_right_special_insurance') ?></h2>
        </div>
        <div class="s-hero-insurance__right_content">
          ...
          <div class="s-hero-insurance__right__list">
            <ul>
              <li>
                <p><?php the_field('title_01_special_insurance') ?></p>
                <span><?php the_field('subtitle_01_special_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_02_special_insurance') ?></p>
                <span><?php the_field('subtitle_02_special_insurance') ?></span>
              </li>
              <li>
                <p><?php the_field('title_03_special_insurance') ?></p>
                <span><?php the_field('subtitle_03_special_insurance') ?></span>
              </li>
            </ul>
          </div>
        </div>
  ...
  <section class="s-extras-opt" id="extras" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h6><?php the_field('mobile_title_section_optional_extras_special_insurance') ?></h6>
      <h4><?php the_field('title_section_optional_extras_special_insurance') ?></h4>
      <ul>
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_optional_extras_cards_special_insurance') ): while ( have_rows('section_optional_extras_cards_special_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_special_insurance') ?>" height="45" width="45" alt="">
              <div class="text">
                <h5><?php the_sub_field('title_card_optional_extras_special_insurance') ?></h5>
  ...
  <section class="s-slide-product" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <div class="top">
        <h6><?php the_field('mobile_title_section_product_slide_special_insurance') ?></h6>
        <h4><?php the_field('title_section_product_slide_special_insurance') ?></h4>
      ...
      <div class="slide-product">
        <div class="swiper-wrapper">
          <!-- Repeater Slide Cards --> 
          <?php if( have_rows('card_product_slide_special_insurance') ): while ( have_rows('card_product_slide_special_insurance') ) : the_row(); ?>
            <div class="swiper-slide">
              <!-- Card Product Type -->
              <a href="<?php the_sub_field('card_link_special_insurance') ?>" class="card-product">
                <div class="image">
                    <img src="<?php the_sub_field('image_card_special_insurance') ?>" alt="card product page" title="card product page">
                </div>
                <div class="info">
                    <h6><?php the_sub_field('card_title_special_insurance') ?></h6>
                    <p><?php the_sub_field('subtitle_card_special_insurance') ?></p>
                    <div class="learn-more">
                      <span><?php the_sub_field('link_card_title_special_insurance') ?></span>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_special_insurance') ?>" class="large-cta js-open-modal" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
  ...
  <section class="s-bespoke" id="why">
    <div class="container">
      <div class="text-top">
        <h6><?php the_field('mobile_title_section_why_us_special_insurance') ?></h6>
        <h4 data-aos="fade-right" data-aos-once="true"><?php the_field('title_section_why_us_special_insurance') ?></h4>
        <p data-aos="fade-left" data-aos-once="true"><?php the_field('subtitle_section_why_us_special_insurance') ?></p>
      </div>
      <div class="main-bespoke">
        <div class="text-bottom" data-aos="fade-right" data-aos-once="true">
          <ul>
            <!-- Repeater Slide Cards --> 
            <?php if( have_rows('cards_section_why_us_special_insurance') ): while ( have_rows('cards_section_why_us_special_insurance') ) : the_row(); ?>
              <!-- Card -->
              <li>
                <img src="<?php the_sub_field('icon_card_special_insurance'); ?>" alt="icon house" title="icon house">
                <h5><?php the_sub_field('title_why_us_card_special_insurance'); ?></h5>
                <p><?php the_sub_field('description_why_us_card_special_insurance'); ?></p>
              </li>
            <?php endwhile; else : endif;?>
          </ul>
        </div>
        <img src="<?php the_field('image_section_why_us_special_insurance') ?>" alt="bespoke image" title="bespoke image" class="bespoke-img" data-aos="fade-left" data-aos-once="true">
      </div>
      <p class="terms-conditions-why-us"><?php the_field('terms_conditions_why_us_special_insurance') ?></p>
    </div>
  </section>
  ...
  <section class="s-price-insurance" id="price">
    <div class="container">
      ...
      <div class="s-price-insurance__card-quote" data-aos="fade-up" data-aos-once="true">
        ...
        <a class="btn btn-primary js-open-modal" href="<?php the_field('link_secondary_card_section_price_special_insurance') ?>">
          <img src="<?php echo get_template_directory_uri()?>/assets/icons/icon-arrow-forward.svg" alt="icon forward arrow white" title="icon forward arrow white" loading="lazy">
          get a quote
        </a>
      </div>
  ...
  <section class="s-faqs padding-bottom" id="faqs" data-aos="fade-up" data-aos-once="true">
    <div class="container">
      <h4><?php the_field('title_section_special_insurance') ?></h4>
      <div class="b-container">
        <!-- Repeater Slide Cards --> 
        <?php if( have_rows('section_faq_special_insurance') ): while ( have_rows('section_faq_special_insurance') ) : the_row(); ?>
          <!-- Question Card -->
          <div class="question">
            <div class="title js-question">
              <strong><?php the_sub_field('title_faq_special_insurance'); ?></strong>
              <i class="fa-solid fa-chevron-down"></i>
            </div>
            <div class="question-content">
              <?php the_sub_field('description_faq_special_insurance'); ?>
            </div>
          </div>
        <?php endwhile; else : endif;?>
      </div>
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_special_insurance') ?>" class="large-cta js-open-modal" data-aos="zoom-in">
        <div class="text">
            <span><?php the_field('subtitle_cta_special_insurance') ?></span>
            <h3><?php the_field('title_cta_special_insurance') ?></h3>
        </div>
  ...
  <?php if ($the_query->have_posts()) : ?>
    <section class="s-articles" id="s-articles">
      <div class="container">
        <div class="text-top">
          <h6><?php the_field('mobile_title_section_articles_special_insurance'); ?></h6>
          <h4><?php the_field('title_section_articles_special_insurance'); ?></h4>
          <p><?php the_field('description_section_articles_special_insurance'); ?></p>
        </div>
