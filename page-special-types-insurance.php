...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <section class="s-hero-insurance">
    <div class="container">
      ...
      <div class="s-hero-insurance__right">
        ...
        <a href="<?php the_field('link_right_special_insurance') ?>" class="btn btn-primary-lg">
  ...
  <div class="s-newsletter">
    <div class="container">
      <a href="<?php the_field('link_cta_special_insurance') ?>" class="large-cta" data-aos="zoom-in" data-aos-once="true">
        <div class="text">
