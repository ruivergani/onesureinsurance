        ...
        <div class="s-hero-insurance__left__list">
          <ul>
            <?php if( have_rows('list_left_special_insurance') ): while ( have_rows('list_left_special_insurance') ) : the_row(); ?>
              <li>
                <img src="<?php the_sub_field('icon_checked_special_insurance') ?>" alt="icon checked" title="icon checked">
        ...
        <?php if( have_rows('section_optional_extras_cards_special_insurance') ): while ( have_rows('section_optional_extras_cards_special_insurance') ) : the_row(); ?>
          <li>
            <div class="extra-button">
              <img src="<?php the_sub_field('image_card_optional_extras_special_insurance') ?>" alt="">
              <div class="text">
